...
export default function Page() {
  ...
  const handleNavigation = () => {
    router.push("/processing2"); // Navigate to the /processing route
  };
  return (
  ...
  <h3 className="text-[28px] font-semibold text-white mb-4">
    Map Dataset Columns
            ...
            <div className="mb-4">
              ...
              >
                Bacterial Infection: <span className="text-red-500">*</span>
              </label>
              <select
            ...
            <div className="mb-4">
              ...
              >
                Source Input: <span className="text-red-500">*</span>
              </label>
              <select
                id="source-input"
                className="w-full bg-[#D9D9D9] text-black rounded-lg"
            ...
            <div className="mb-4">
              ...
              >
                Antibiotic Format: <span className="text-red-500">*</span>
              </label>
              <input
  ...
  <h3 className="text-[28px] font-semibold text-white mb-4">
    Map Dataset Columns
            ...
            <div className="mb-4">
              ...
              >
                Dataset Format: <span className="text-red-500">*</span>
              </label>
              <select
                id="dataset-format"
                className="w-full bg-[#D9D9D9] text-black rounded-lg"
