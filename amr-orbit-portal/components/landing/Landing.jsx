...
<h1 className="text-4xl lg:text-5xl 3xl:text-6xl 4xl:text-7xl font-bold text-gray-100 text-center">
    AMR <span className="text-[#BAC0DF]">Surveillance</span> Platform
</h1>
...
The AMR Surveillance Platform empowers healthcare providers and researchers to monitor and combat antimicrobial resistance effectively. Upload your dataset to seamlessly generate in-depth Isolation Analysis, track trends through Resistance Analysis, and access comprehensive Scorecards for actionable insights. Simplify complex data interpretation and enhance decision-making in your AMR studies with our user-friendly, data-driven platform.
                </p>
            </motion.div>
        </div>
    );
